  ...
  <body>
    ...
    >
      <div
        class="parallax-bg"
        style="
          background-image: url(https://images.unsplash.com/photo-1627931085762-4017812f1773?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80);
        "
        data-swiper-parallax="-23%"
      ></div>
      <div class="swiper-wrapper">
        <div class="swiper-slide" style="height: 700px;">
          <div class="title" data-swiper-parallax="-300">About us</div>
          <div class="subtitle" data-swiper-parallax="-200">Red Cock</div>
          <div class="text" data-swiper-parallax="-100">
            <p>
            Инспирирани од најдобрите во Нешвил и Кентаки, Тимот на Ред Кок се обидува да Ви пружи искуство и вкус кој што во Македонија ретко може да се најде. Се трудиме во нашиот прекрасен град да понудиме производи кои досега ги немало, вкусови кои ќе ги запаметите и високи стандарди на готвење кои се разликуваат од сите други што сте ги искусиле во нашата држава. Нашата цел е да понудиме нови производи, нови комбинации на вкусови и да докажеме дека не секогаш класичниот вкус е подобар. Ќе ни биде чест да ни се придружите во нашата кулинарска авантура и потрага по совршенство, и заедно со вашите идеи, желби, предлози (и нормално повремени забелешки) заедно да го достигнеме гастрономскиот врв. Им Благодариме на нашите досегашни, и ги Добредојдуваме нашите нови клиенти на кои им ветуваме дека нема да завршат без насмевка, полн стомак и целосно задоволство.
„Совршенството се постигнува, не кога нема што повеќе да се додаде, туку кога ништо повеќе неможе да се одземе“ Антоан де Сен – Ексупери
            </p>
          </div>
        </div>
...
Inspired by the best in Nashville and Kentucky, Red Cock’s Team is trying to offer You an experience and flavor that can rarely be found in Macedonia. In our lovely town Shtip will try to offer some new products that you haven’t seen before, flavors that you will remember and top cooking standards that are different to anything you’ve ever tasted in our country. Our goal is to offer a superior product, some new combinations of flavor and to prove that the classics aren’t always better than what is new. We would be honored if You join us in Our culinary adventure and Our search of perfection and together with your ideas, wishes and suggestions (and of course, the occasional remarks) to reach the gastronomic peak. We Thank our current and we Welcome our new clients to whom we Promise that they will not be leaving without a smile, a full belly and complite satisfaction.
            </p>
          </div>
        </div>
        <div class="swiper-slide">
...
<div id="home" class="w3-content" style="max-width: 100%;">

<!-- About -->
<div id="about" class="w3-container w3-red w3-grayscale w3-xlarge w3-padding-64" style="padding-left: 64px;">

<h1><b>Opening Hours</b></h1>
<div class="w3-row">
<div class="w3-half">
  <p>Monday-Saturday:</p>
  <p>8:30 AM - 11:30 PM</p>
  <p>Sunday Closed</p>
</div>
<div class="w3-half">
  
  <p>Call: +389 32 605 099</p>
  <p>General M. Apostolski 2000 Stip</p>
</div>
</div>    
</div>
