...
<div class="header">
  ...
  <section id="txt" class="txt">
     <div class="chickenjpg">
       <style>
        header {
      background-image: url(https://images.unsplash.com/photo-1626645738196-c2a7c87a8f58?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80);
      height: 920px;
      ...
      width: 100%;
       ...
       <embed src="/img/cock.svg" width="750" height="750" style="position: relative; top:231px;">
     <h1 class="glowing">Red</h1> 
     <h3 class="black">Cock</h3>
     <h1 class="white">THE BEST</h1>
     <h3 class="fried">FRIED <br>CHICKEN</br></h3>
  </section>
 </div>
</header>
